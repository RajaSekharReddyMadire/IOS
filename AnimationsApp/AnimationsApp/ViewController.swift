...
//  AnimationsApp
//
//  Created by Madire,Rajasekhara Reddy on 3/28/23.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        //Move the image view outside of the screen
    ...
    func updateAndAnimate(_ imageName : String){
        ...
        //Assign the new image with animation and make it  transperant (alpha =1)
